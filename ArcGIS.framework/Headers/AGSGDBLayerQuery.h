...
/** @brief Parameters to download a replica geodatabase
  ...
  In addition to the @c AGSGDBGenerateParameters#layerIDs and @c AGSGDBGenerateParameters#extent parameters, parameters on this class be used to further define what is included in the replica geodatabase on a layer-by-layer basis.
...
/** Specifies whether to include any data from this layer that is related to data in other layers in the replica.
...
/** Defines whether and how filters will be applied to a layer. 
 @since 10.2
 */
/** Specifies on what basis features should be considered for inclusion into the replica geodatabase.
 @since 10.2
 */
