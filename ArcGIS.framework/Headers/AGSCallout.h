...
/** Text for title label. The title for a feature is provided by 
 @p infoTemplateDelegate on @c AGSFeature. The title for a AGSLocationDisplay location is
 provided by @p infoTemplateDelegate on @c AGSLocationDisplay. 
 @agssince{1.0, 10.2}
 */
@property (nonatomic, copy) NSString *title;

/** Text for detail string. The detail for a feature is provided by 
 @p infoTemplateDelegate on @c AGSFeature. The detail for a AGSLocationDisplay location is
 provided by @p infoTemplateDelegate on @c AGSLocationDisplay.
 @agssince{1.0, 10.2}
 */
...
/** Show callout at specified location for a specific feature. The feature's
 <code>attributes</code> and <code>infoTemplateDelegate</code> will be used to
 display content in the callout.
 @param mapPoint Map point that will be used for the callout. You can pass <code>nil</code>
