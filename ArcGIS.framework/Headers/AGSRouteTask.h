...
/**
 ...
 @agssince{10.2, 10.2}
 @note This method is Beta at 10.2.
 */
...
/**
 Return an initialized, auto released, route task that works with a local network dataset within the application bundle.
...
/**
 Initializes route task that works with a local network dataset within the application bundle.
 @param name of the database (the *.geodatabase file)
 @param network common prefix in the name of network files under the *.tn folder
 @param error NSError if error occurs during task creation then this is populated with error
 @agssince{10.2, 10.2}
