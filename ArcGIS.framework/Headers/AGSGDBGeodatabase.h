...
/** @brief A local geodatabase 
 
 Instances of this class represent a local geodatabase containing
 geographic datasets.
 
 @see @c AGSGDBTask to download the geodatabase from a sync enabled ArcGIS Feature service.
...
/** The credentials that were used to download this geodatabase
 ...
 wasn't secured or if the geodatabase wasn't downloaded from a service.
 @since 10.2
 */
@property (nonatomic, copy, readwrite) AGSCredential *credential;

/** The path on disk where this geodatabase is available.
 @since 10.2
 */
...
/** Retrieve the dataset that corresponds to a paricular layerID in the
