...
/** @brief Information about an ArcGIS Feature service
 ...
 This class holds metadata about an ArcGIS Feature service. The service may be hosted on ArcGIS Online (Esri's cloud platform) or on your own on-premise ArcGIS server.
 
 An instance of the class is available from @c AGSGDBTask#featureServiceInfo once the task has finished loading. It may be used to instantiate an @c AGSGDBGenerateParameters which will set up some convenient defaults.
