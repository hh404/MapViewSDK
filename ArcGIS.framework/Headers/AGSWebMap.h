...
/** The @c AGSMapView, if any, that the this @cAGSWebMap has been opened up into or is currently opening into.
 @agssince{10.2, 10.2}
 */
...
/** Indicates if there are any popups defined on any layer in this webmap.
 The webmap must be fully loaded before any popups can be discovered.
 Wait for the #c AGSWebMapDelegate::webMapDidLoad method to fire before you call this method.
  @agssince{10.2, 10.2}
 */
