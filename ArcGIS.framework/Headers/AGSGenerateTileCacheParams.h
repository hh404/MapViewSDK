...
/** @brief Parameters for @c AGSTileCacheTask to create and download a tile cache
 
 This class holds parameters describing the tile cache that should be returned by
 @c AGSTileCacheTask#generateTileCacheAndDownloadWithParameters:downloadFolderPath:useExisting:status:completion:
 
 @define{AGSGenerateTileCacheParams.h, ArcGIS}
 @agssince{10.2, 10.2}
 */

@interface AGSGenerateTileCacheParams : NSObject<NSCoding>
...
/**
 ...
 You can inspect @c AGSTileCacheTask#tiledServiceInfo to find out 
